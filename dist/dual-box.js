...
(function () {
    ...
    .directive('dualBox', function () {
        return {
            ...
            + '<select multiple ng-model="available" ng-options="items[key_select] for items in available_filtered = (available_items | filter: available_search)" class="form-control"></select>'
            + '</div>'
            ...
            + '<select multiple ng-model="selected" ng-options="items[key_select] for items in selected_filtered = (selected_items | filter: selected_search)" class="form-control"></select>'
            + '</div>'
            + '</div>',
